...
import { getSkillDescription } from '@/lib/data/skillDescriptions';
              ...
              {categorySkills.map((skill) => (
                <Tooltip
                  ...
                  classNames={{
                    base: 'max-w-xs',
                    content:
                      'bg-muted text-foreground text-sm p-2 rounded-lg border border-border shadow-lg',
                  }}
                >
                  <div className="space-y-1 cursor-help transition-all hover:scale-[1.02]">
