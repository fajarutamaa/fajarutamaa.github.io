...
export const metadata = {
    ...
    description: 'Learn more about Fajar Dwi Utomo, a Junior Software Engineer passionate about building things people love.',
};
        ...
        <div className="container max-w-[680px] lg:max-w-[900px] py-12 space-y-16">
            ...
            <section className="space-y-6 animate-fadeIn" style={{ animationDelay: '100ms' }}>
                ...
                <div className="prose prose-neutral dark:prose-invert max-w-none space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                        Hi! I&apos;m Fajar Dwi Utomo, a passionate Junior Software Engineer with a love for creating
                        beautiful, functional, and user-friendly applications. I specialize in web development
                        and enjoy working with modern technologies to build solutions that make a difference.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        projects, or sharing my knowledge through writing on{' '}
                        <a
